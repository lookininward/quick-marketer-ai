...
export default function Home() {
  ...
  return (
    <main className="py-7 px-10 flex flex-col align-center">
      <h1 className="text-xl font-semibold mb-4">Quick Marketer AI</h1>
      <p className='text-gray-700'>Revolutionizing Your Marketing Content Creation</p>
      <div>
